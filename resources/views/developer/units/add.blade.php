                                    ...
                                    <div>
                                        <div class="profile-radio-custom ">
                                            @foreach($build->phases as $phase)
                                                <div
                                                    class="new-custom-radio green-gray-raduis typeofbuild typeofbuildcheck active">
                                                    <label>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="admin-sec input-w-unset mt-85">
                        ...
                        <form action="{{route('developer.project.create')}}" method="post"
                                    ...
                                    per SQ/FT
                                        ...
                                        <div class="profile-input-custom mb-12">
                                            ...
                                            <div class="input-custom flex-auto self no-logo w-100">
                                                ...
                                                <input type="text" class="phase-txt"
                                                       placeholder="Type Name Of Phase...">
                                            </div>
                                        </div>
                                        <div class="">
        ...
        <script>
            ...
            function addPhase() {
                ...
                if (ofd.length == 0) {
                    ...
                    = "green-gray-raduis ml-12 position-relative d-inline-block" > ' +
                    per + ',' + ofd + '<input type="hidden" name="phasesType[]" value="' + per + '">' +
                    '<input type="hidden" name="phasesName[]" value="' + ofd + '">' +
                    '<span class="delete-pase-btn" onclick="deletePhase(this)"> <svg width="15" height="15" viewBox="0 0 22 22"
                    fill = "none"
