                            ...
                            <div class="d-flex">
                                <div class="">
                                    <label for="select-image">
                                        ...
                                        <input type="file" id="select-image" multiple style="display: none">
                                    </label>
            ...
            `;
                                ...
                                <span>
                                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                                        ...
                                        <path d="M7.5 6.875C8.88071 6.875 10 5.75571 10 4.375C10 2.99429 8.88071 1.875 7.5 1.875C6.11929 1.875 5 2.99429 5 4.375C5 5.75571 6.11929 6.875 7.5 6.875Z"
                                            ...
                                            <input type="text" placeholder="Add Project Location">
                                        </div>
                                    ...
                                    <div class="profile-input-custom set-deposit-col-margin">
                                        ...
                                        <div class="input-custom w-220 flex-auto svg-left self no-logo">
                                            ...
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path d="M12.5 7.29167V17.7083M7.29167 12.5H17.7083M21.875 12.5C21.875 17.6777 17.6777 21.875 12.5 21.875C7.32233 21.875 3.125 17.6777 3.125 12.5C3.125 7.32233 7.32233 3.125 12.5 3.125C17.6777 3.125 21.875 7.32233 21.875 12.5Z"
                                    ...
                                    <div class="profile-input-custom ">
                                        ...
                                        <div class="input-custom Assignment-no flex-auto self no-logo">

                                            <input type="text" placeholder="No" value="No">
                                        </div>
                                        <div class="input-custom Assignment-no-secto  self no-logo">
                                    ...
                                    <div class="profile-radio-custom ">
                                        ...
                                        <div class="new-custom-radio active">
                                            <label>
                                                Townhomes
                                                <input type="radio">
                                            </label>
                                    ...
                                    <div class=" ">
                                        <button class="calender-btn">
                                            <svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path d="M5 3.59375C4.74375 3.59375 4.53125 3.38125 4.53125 3.125V1.25C4.53125 0.99375 4.74375 0.78125 5 0.78125C5.25625 0.78125 5.46875 0.99375 5.46875 1.25V3.125C5.46875 3.38125 5.25625 3.59375 5 3.59375Z"
                                                      fill="white"/>
                                                <path d="M10 3.59375C9.74375 3.59375 9.53125 3.38125 9.53125 3.125V1.25C9.53125 0.99375 9.74375 0.78125 10 0.78125C10.2563 0.78125 10.4688 0.99375 10.4688 1.25V3.125C10.4688 3.38125 10.2563 3.59375 10 3.59375Z"
                                                      fill="white"/>
                                                ...
                                                <path d="M5.3125 11.25C5.23125 11.25 5.15 11.2313 5.075 11.2C5 11.1688 4.93125 11.125 4.86875 11.0687C4.75625 10.95 4.6875 10.7875 4.6875 10.625C4.6875 10.5437 4.70625 10.4625 4.7375 10.3875C4.76875 10.3062 4.8125 10.2375 4.86875 10.1813C5.1 9.95 5.525 9.95 5.75625 10.1813C5.86875 10.3 5.9375 10.4625 5.9375 10.625C5.9375 10.7875 5.86875 10.95 5.75625 11.0687C5.6375 11.1812 5.475 11.25 5.3125 11.25Z"
                                                      fill="white"/>
                                                <path d="M7.5 11.25C7.3375 11.25 7.175 11.1812 7.05625 11.0687C6.94375 10.95 6.875 10.7875 6.875 10.625C6.875 10.5437 6.89375 10.4625 6.925 10.3875C6.95625 10.3062 7 10.2375 7.05625 10.1813C7.2875 9.95 7.7125 9.95 7.94375 10.1813C8 10.2375 8.04375 10.3062 8.075 10.3875C8.10625 10.4625 8.125 10.5437 8.125 10.625C8.125 10.7875 8.05625 10.95 7.94375 11.0687C7.825 11.1812 7.6625 11.25 7.5 11.25Z"
                                                      fill="white"/>
                                                <path d="M9.6875 11.2501C9.525 11.2501 9.3625 11.1813 9.24375 11.0688C9.1875 11.0126 9.14375 10.9438 9.1125 10.8626C9.08125 10.7876 9.0625 10.7063 9.0625 10.6251C9.0625 10.5438 9.08125 10.4626 9.1125 10.3876C9.14375 10.3063 9.1875 10.2376 9.24375 10.1813C9.3875 10.0376 9.60625 9.96881 9.80625 10.0126C9.85 10.0188 9.8875 10.0313 9.925 10.0501C9.9625 10.0626 10 10.0813 10.0375 10.1063C10.0688 10.1251 10.1 10.1563 10.1312 10.1813C10.2437 10.3001 10.3125 10.4626 10.3125 10.6251C10.3125 10.7876 10.2437 10.9501 10.1312 11.0688C10.0125 11.1813 9.85 11.2501 9.6875 11.2501Z"
                                                      fill="white"/>
                                                <path d="M12.8125 6.15002H2.1875C1.93125 6.15002 1.71875 5.93752 1.71875 5.68127C1.71875 5.42502 1.93125 5.21252 2.1875 5.21252H12.8125C13.0688 5.21252 13.2812 5.42502 13.2812 5.68127C13.2812 5.93752 13.0688 6.15002 12.8125 6.15002Z"
                                                      fill="white"/>
                                        ...
                                        <div class="profile-input-custom d-inline-block">

                                            <div class="input-custom compilition-date-input flex-auto self no-logo">

                                                <input type="text" class="" placeholder="Year" value="">
                                            </div>
                                            <div class="input-custom compilition-date-input flex-auto self no-logo">

                                                <input type="text" class="" placeholder="Month" value="">
                                            </div>
                        ...
                        <div class="have-back-shadow add-developer-padding section-input-bdrs-unset mt-70">
                            ...
                            <div class="d-flex">
                                <div class="">
                                    <div class="uploader">
                                        <img src="assets/img/Frame%2080.svg" alt="">
                                    </div>
                                </div>
                                <div class=" flex-auto ms-4 vertical-top border-left-custom developer-general-info">
                                    <div class="profile-input-custom d-flex">
                                    ...
                                    <div class="profile-textarea-custom">
                                        <textarea placeholder="type down description here..."></textarea>
