@extends('app')
@section('content')
    @if($user->realtorIsActive())
        <x-realtor.realtor-bar active="profile"></x-realtor.realtor-bar>
    @else
        <div class="admin-nav-bar">
            <div class="container">
                <h4 class="alert alert-warning">
                    Fill in the required information below to activate the account
                </h4>
...
'
                                ...
                                <div>
                                    <x-CustomForms.inputCustom inputLabel="youtube"
