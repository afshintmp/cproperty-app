                ...
                <ul class="pagination">
                    ...
                    @foreach ($elements as $element)
                        ...
                        @if (is_string($element))
                            <li class="page-item-custom disabled" aria-disabled="true"><span
                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <li class="page-item-custom active-custom" aria-current="page"><span
                                            class="page-link-custom">{{ $page }}</span></li>
                                @else
                                    <li class="page-item-custom"><a class="page-link-custom"
                                                                    href="{{ $url }}">{{ $page }}</a></li>
                                @endif
                            @endforeach
                        @endif
